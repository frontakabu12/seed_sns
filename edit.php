<?php  
  ...
  if (isset($_POST) && !empty($_POST["tweet"])) {
    ...
    //SQL文を実行
      ...
      $data = array($_POST['tweet'], $_GET["tweet_id"]);    // $data = array($_POST['tweet'], $_SESSION["id"], -1);
        ...
        <div class="msg">
          <form method="post" action="" class="form-horizontal" role="form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <textarea name="tweet" cols="50" rows="5" class="form-control" placeholder="例：Hello World!"><?php echo $tweet_id["tweet"]; ?></textarea>
              </div>
            </div>
            <ul class="paging">
